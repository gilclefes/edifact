...
namespace Edifact.SpecifiedSegments
{
	public class NadSegment : Segment
	{
		...
		public string Name1 { get { return base[3, 0] ?? ""; } set { base[3, 0] = value; } }
		public string Name2 { get { return base[3, 1] ?? ""; } set { base[3, 1] = value; } }
		public string Address1 { get { return base[4, 0] ?? ""; } set { base[5, 0] = value; } }
